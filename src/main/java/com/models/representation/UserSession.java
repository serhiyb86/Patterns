...
public class UserSession implements java.io.Serializable {
	...
	private List<Coverage> coverages = new ArrayList<com.models.representation.Coverage>();

	private List<MonitorArea> monitorScope = new ArrayList<com.models.representation.MonitorArea>();
