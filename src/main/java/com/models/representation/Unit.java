...
public class Unit implements Serializable {
	...
	private List<PersonnelHandle> assignedPersonnel = new ArrayList<com.models.representation.PersonnelHandle>();

	private List<Capability> incidentQualification = new ArrayList<com.models.representation.Capability>();

	private List<Capability> capabilities = new ArrayList<com.models.representation.Capability>();

	private List<Equipment> equipment = new ArrayList<com.models.representation.Equipment>();
	...
	public java.util.Date getWhenStatusDeclared() {
