...
import com.models.security.authenticators.Authenticator;
import com.models.security.authenticators.CustomGlobalAuthenticator;
import com.models.security.authenticators.NoAuthAuthenticator;
import com.models.security.authenticators.OAuth2ImplicitFlowAuthenticator;
import com.models.security.authenticators.defined.Api_keyAuthenticator;
...
public class SecurityConfig {
     ...
     */
    public SecurityConfig configureAuthApi_key(String token) {
        configureAuth(new Api_keyAuthenticator(token));
        return this;
    }
     ...
     *
     * @param scheme
     *            the scheme to override ; should be a class from com.models.security.authenticators
     * @param replacement
